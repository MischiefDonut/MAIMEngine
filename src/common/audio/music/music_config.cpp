...
CUSTOM_CVAR(String, fluid_patchset, GAMENAME, CVAR_ARCHIVE | CVAR_GLOBALCONFIG | CVAR_VIRTUAL | CVAR_SYSTEM_ONLY)
{
...
CUSTOM_CVAR(String, timidity_config, GAMENAME, CVAR_ARCHIVE | CVAR_GLOBALCONFIG | CVAR_VIRTUAL | CVAR_SYSTEM_ONLY)
{
