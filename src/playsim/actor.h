...
// movement flags
	...
	//MF_SPAWNSOUNDSOURCE	= 0x04000000,	// Plays missile's see sound at spawning object. [DISDAIN] MOVED TO MF8_SPAWNSOUNDSOURCE
...
enum ActorFlag8
{
	...
	MF8_SPAWNSOUNDSOURCE= 0x00004000,	// Plays missile's see sound at spawning object. [DISDAIN] ORIGINALLY MF_SPAWNSOUNDSOURCE
...
enum ActorRenderFlag2
{
	...
	RF2_TRACELIT				= 0x8000,	// [DISDAIN] actor is lit using tracelighting instead of probes
};
...
// interaction info
	...
	int				StartHealth;
	int				PrevSpawnHealth; // [DISDAIN] For tracking health scaling in co-op
