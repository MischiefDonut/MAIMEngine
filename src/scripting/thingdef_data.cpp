...
static FFlagDef ActorFlagDefs[]=
{
	...
	DEFINE_FLAG(MF, AIMASSISTTARGET, AActor, flags), // [DISDAIN] had to swap SPAWNSOUN out for this for the aim assist code
	...
	DEFINE_FLAG(MF8, SPAWNSOUNDSOURCE, AActor, flags8), // [DISDAIN] had to move the flag location to accomodate the aim assist code
	...
	DEFINE_FLAG(RF2, TRACELIT, AActor, renderflags2),
